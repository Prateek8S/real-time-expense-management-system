...
def analytics_tab():
    ...
    if st.button("Get Analytics"):
        ...
        ## Creating a dataframe from the response data
        data = {
            "Category": list(response_data.keys()),
            "Total Amount": [response_data[category]["total_amount"] for category in response_data],
        ...
        st.bar_chart(data = df_sorted.set_index("Category")["Percentage"], width=1000, height=400, use_container_width=False)
